                                                                ...
                                                                <?php
                                                                    ...
                                                                    <div class="col-xxl-6">
                                                                        <div >
                                                                            ...
                                                                            <a href="../admin/uploads/<?php echo $row['file'];?>" download class="ps-2 btn btn-sm btn-success edit-item-btn"> Download</a>
                                                                            <a href="../admin/uploads/<?php echo $row['file'];?>" class="ps-2 btn btn-sm btn-warning edit-item-btn" target="_blank">Viwe Document</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                <?php
