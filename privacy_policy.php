...
?>
<head>
    <title>Privacy Policy-CRM Landing</title>
</head>
<style>
    p{
        text-align:justify;
...
<div id="content" class="site-content ">
    ...
    <div class="page_header_default style_one ">
        ...
        <div class="page_header_content">
            <div class="auto-container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="banner_title_inner" style="margin-bottom:12px;">
    ...
    <section class="newsteller style_one  disNone "> 
        <div class="container-fluid" id="consulting">
            
            <div class="row align-items-start">

               
                <div class="col-lg-12 col-md-12 col-xl-12 col-xxl-12 col-12 row" style="padding:0px 0px;">
                   
                    <div class="pd_top_10"></div>
                    <div class="item_scubscribe">
                        <div class="input_group">
                            <div class="col-lg-12 float-start pb-4 container-fluid">
                                <div style="padding:40px;">
                                    <div class="pt-3">
                                        <p style="text-align: justify;">
                                            
                                            This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.
                                        We collect your personal data with our forms. 
                                       We use your data to provide and improve the Service. By using the Service, Service, you agree to collect and use information under this Privacy Policy.</p>
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to CRM Landing Add.: 2nd Floor, Shyama Royal, Near Mamta Sweets, Shastri Nagar, Ajmer - Rajasthan. (305001). INDIA. 
...
Usage Data refers to data collected automatically, either generated by the Service or from the Service infrastructure itself (for example, a page visit's duration). 

Website refers to CRM Landing, accessible from <a href="#" style="color:#0000EE">https://crmlanding.in/ </a>

You mean the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable. 

Collecting and Using Your Personal Data </p>


<h3 class="mt-4">Types of Data Collected </h3>
<h5>Personal Data </h5><p>
...
<h5>Retention of Your Personal Data </h5><p>
...
<h5>Other legal requirements </h5><p>
...
By email: <a href="#" style="color:#0000EE">support@crmlanding.in </a><br>

By Call: <a href="#" style="color:#0000EE">+91 86199 48778 
  ...
  <section class="newsteller style_one  disLapNone">
        <div class="container-fluid" id="consulting">
            <div class="row align-items-start">
             ...
             <div class="col-lg-12 col-md-12 col-xl-12 col-xxl-12 col-12 row" style="padding:0px 0px;">
                    ...
                    <div class="item_scubscribe">
                        <div class="input_group">
                            <div class="col-lg-11 float-start pb-4 container "> 
                                <div class="container">
                                    <div class="pt-3">
                                        <p style="text-align: justify;">
