...
$(document).ready(function() {
    ...
    function updateIcons() {
        ...
        if (y.matches) {
            ...
            addDropdownIcons('fa-angle-down');
            
        } else {
            // For screen widths below 1000px
            addDropdownIcons('fa-plus');
             function toggle(id){
    ...
    function addDropdownIcons(iconClass) {
       
        // Clear existing icons to avoid duplicates
        $('header .navbar_nav li.dropdown .dropdown-btn, header .navbar_nav li.mega_menu .fa, .crt_mobile_menu .navbar_nav li.dropdown .dropdown-btn, .crt_mobile_menu .navbar_nav li.mega_menu .fa').remove();

        if ($('header .navbar_nav li.dropdown ul').length) {
            $('header .navbar_nav li.dropdown').each(function() {
                $(this).append('<div class="dropdown-btn" onclick="toggleSection(this)" id="plus' + z++ + '"><span class="fa ' + iconClass + ' icon1"></span></div>');
            });
        }
        if ($('header .navbar_nav li.mega_menu ul').length) {
            $('header .navbar_nav li.mega_menu a.nav-link').each(function() {
                $(this).append('<span class="fa ' + iconClass + ' icon1" id="plus' + z++ + '"></span>');
            });
        }
        if ($('.crt_mobile_menu .navbar_nav li.dropdown ul').length) {
            $('.crt_mobile_menu .navbar_nav li.dropdown').each(function() {
                $(this).append('<div class="dropdown-btn" onclick="toggleSection(this)" id="plus' + z++ + '"><span class="fa ' + iconClass + ' icon1"></span></div>');
            });
        }
        if ($('.crt_mobile_menu .navbar_nav li.mega_menu ul').length) {
            $('.crt_mobile_menu .navbar_nav li.mega_menu a.nav-link').each(function() {
                $(this).append('<span class="fa ' + iconClass + ' icon1" id="plus' + z++ + '"></span>');
            });
        }
    ...
    // Initial call to set icons based on the current screen width
    updateIcons();
...
function toggleSection(element) {
    ...
    console.log('Toggled section for element with ID:', element.id);
}
