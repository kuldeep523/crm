...
if(!empty($_POST['submit'])){
    ...
    $qu="UPDATE `about_us_us` SET `title`='$title',`video`='$n',`content`='$content' WHERE id='$id' ";
    $qu_run=mysqli_query($conn,$qu);
    ?>
    <script>alert("Update successfully");window.location.href='about_us.php';</script>
    <?php
}
?>
<!doctype html>
...
<head>
    ...
    <meta charset="utf-8" />
    <title>CRM Landing | About Us</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 row mx-0">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="title" class="form-control mb-3" placeholder="Enter Title" value='<?php echo $row[1]; ?>'>
                            </div>
                            
                             <div class="col-lg-6">
                                <label for="address" class="form-label ">Video<strong style="color:red;"> * <sup></sup></strong></label>
                                <input type="file" name="file" accept=".mp4" class="form-control mb-3">
                            </div>
                            <div  class="col-lg-12">
                                <label class="form-label" for="stocks-input">Content<strong style="color:red;">*</strong></label>
                                <textarea id="" name="content" class="form-control" placeholder="Enter Content" id="" cols="3" rows="3" ><?php echo $row[3]; ?></textarea>
                            </div>
