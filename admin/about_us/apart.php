...
if(!empty($_GET['did'])){
     $did=$_GET['did'];  
    $d = "DELETE FROM `about_us_apart` WHERE id='$did'";
    $d_r = mysqli_query($conn,$d);
    ?>
    <script>window.location.href="apart.php";</script>
    <?php
}
...
{   
    $sid = $_GET['sid'];
    $status = $_GET['status'];
    $query = "UPDATE `about_us_apart` SET `status`='$status' WHERE id=$sid";
...
if(!empty($_POST['submit'])){
    ...
    $squery = "INSERT INTO `about_us_apart`(`title`,`icon`, `content`,`status`) VALUES ('$title','$filename','$content','Active')";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class="mb-sm-0">Sets Us Apart</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">About Us</a></li>
                                <li class="breadcrumb-item active">Sets Us Apart</li>
                            </ol>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 row">
                            ...
                            <div class="col-lg-6">
                                <label for="address" class="form-label ">icon<strong style="color:red;"> * image must be w=85*h=85</strong></label>
                            ...
                            <div  class="col-lg-12 pb-3">
                                    ...
                                    <textarea id="ckeditor- classic" name="content" class="form-control" placeholder="" id="" cols="3" rows="3" ></textarea>
                            </div>
...
-->
                                    ...
                                    <div id="example_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <?php
                                            $caseq= "SELECT * FROM `about_us_apart`";
                                        ...
                                        <tbody>
                                          ...
                                          ?>                                                                                                
                                            <tr class="odd">
                                                ...
                                                <td><img src="../uploads/<?php echo $case_r['icon']; ?>" alt="" height="75px" width="75px"></td>
