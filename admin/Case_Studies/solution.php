...
if(!empty($_GET['did'])){
     $did=$_GET['did']; 
      $id=$_GET['id']; 
    $d = "DELETE FROM `Case_Studies_Solution` WHERE id='$did'";
    $d_r = mysqli_query($conn,$d);
    ?>
    <script>window.location.href="solution.php?id=<?php echo $id; ?>";</script>
    <?php
}
...
{   
    $sid = $_GET['sid'];
    $status = $_GET['status'];
    $query = "UPDATE `Case_Studies_Solution` SET `status`='$status' WHERE id=$sid";
...
if(!empty($_POST['submit'])){
    ...
    $squery = "INSERT INTO `Case_Studies_Solution`(`Case_Studies_Id`, `title`, `content`, `img`, `status`) VALUES ('$id','$title','$content','$filename','Active')";
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 row">
                            <div class="col-lg-6">
                                <label for="address" class="form-label ">Solution Title<strong style="color:red;">*</strong></label>
                                <input type="text" name="title" class="form-control mb-3" placeholder="Enter Service Heading" >
                            </div>
                            
                            <div class="col-lg-6">
                                <label for="address" class="form-label ">Image<strong style="color:red;"> * image must be w=80*h=80</strong></label>
...
-->
                                    ...
                                    <div id="example_wrapper" class="dataTables_wrapper no-footer">
                                        ...
                                        <?php
                                            $caseq= "SELECT * FROM `Case_Studies_Solution` where Case_Studies_id='$id'";
